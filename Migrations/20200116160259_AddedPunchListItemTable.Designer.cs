...
namespace WatchdogApi.Migrations
{
    ...
    [Migration("20200116160259_AddedPunchListItemTable")]
    partial class AddedPunchListItemTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WatchdogApi.Models.PunchListItem", b =>
                {
                    ...
                    b.Property<int?>("AssignPersonsId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("AssignPersonsId");

                    b.HasIndex("BuildingId");

                    b.HasIndex("FacilityId");

                    b.HasIndex("RequestorsId");
            ...
            modelBuilder.Entity("WatchdogApi.Models.PunchListItem", b =>
                {
                    b.HasOne("WatchdogApi.Models.AssignPerson", "AssignPersons")
                        .WithMany()
                        .HasForeignKey("AssignPersonsId");

                    b.HasOne("WatchdogApi.Models.Building", "Buildings")
                        .WithMany()
                    ...
                    b.HasOne("WatchdogApi.Models.Requestor", "Requestors")
                        .WithMany()
                        .HasForeignKey("RequestorsId");

                    b.HasOne("WatchdogApi.Models.Scope", "Scopes")
                        .WithMany()
